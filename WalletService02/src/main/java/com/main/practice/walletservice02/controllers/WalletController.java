package com.main.practice.walletservice02.controllers;
...
import com.main.practice.walletservice02.services.UserAccountService;
...
public class WalletController {
    ...
    public ResponseEntity<UserAccount> createUser(
            @RequestBody UserAccountCreateReqDto request
    ) {
    ...
    public ResponseEntity<String> refund(
        ...
        try {
            ...
            return ResponseEntity.status(500)
                    .body("CRITICAL: Refund Failed! " + e.getMessage());
        }
    }
}
